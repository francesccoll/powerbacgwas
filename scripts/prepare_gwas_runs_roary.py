...
def _main():
    ...
    input_files = [args.roary_table, args.similarity, args.parameters_file, args.pastml_steps_file]
                    ...
                    for ncv in number_causal_variants:
                        for sr in list(range(1, int(sampling_repetitions)+1, 1)):
                            for ss in sample_size:
                                ...
                                command_line += 'python3 ' + code_directory + 'sample_casual_variants_from_roary.py' \
