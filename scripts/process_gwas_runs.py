...
def parse_arguments():
    ...
    group.add_argument(
        ...
        help="VCF (v), VCF burden (b) or Roary presence/absence (r) (Default: v)",
...
def _main():
    ...
    with open(args.gwas_runs_in_table, 'r') as input_file:
        ...
        for input_line in input_file:
            ...
            causal_variants_file = output_dir + combination_id + '.causal_variants.txt'
            if args.variant_type == 'b':
                causal_variants_file = output_dir + combination_id + '.causal_regions.txt'
