...
def _main():
    ...
    input_files = [args.input_vcf, args.similarity, args.parameters_file, args.pastml_steps_file]
                    ...
                    for ncv in number_causal_variants:
                        for sr in list(range(1, int(sampling_repetitions)+1, 1)):
                            for ss in sample_size:
                                ...
                                command_line += 'then\n'
                                command_line += 'python3 ' + code_directory + 'sample_casual_variants_from_vcf.py' \
                                ...
                                command_line += 'then\n'
                                if len(heritability) > 1:
                                    command_line += 'python3 ' + code_directory + 'simulate_phenotype_using_gcta.py' \
                                    ...
                                    command_line += 'python3 ' + code_directory + 'plink_to_pyseer_phenotype_file.py' \
